...
@section('content')
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">{{__('message.List Categories')}}</h1>
            <p class="lead text-muted"> </p>
            <p>
                <a href={{"categories/create"}} class="btn btn-primary my-2">{{__('message.Create New Category')}}</a>
            </p>
        </div>
    </section>
    <main role="main" class="container">
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            <h6 class="border-bottom border-gray pb-2 mb-0">{{__('message.Categories')}}</h6>
            ...
            <div class="media text-muted pt-3">
                ...
                <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <a href={{"/categories/".$category->id}} type="button" class="btn btn-sm btn-outline-secondary">{{__('message.View Details')}}</a>
                    </div>
